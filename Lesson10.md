...
// Helper that recurively merges two data objects together
...
/*
  ...
  to assets defined in its acestor chain
*/
export function resolveAsset (
  ...
  if (hasOwn(assets, PascalCaseId)) return assets[camelizedId]
